...
### R11 補(9/15 00:50):週六上午也有課

糯糯:平日晚上第 11–14 節之外,**週六上午從第 1 節 08:10 開始**上課。所以「時間軸 = 最早→最晚」會拉出 08:10–22:10 一整條、中間空一大段,不對。改成:
- **時間軸 = 該學期有任何 slot 的節次集合,中間沒課的節次折疊成一條細線**(例:1–4 節、折疊、11–14 節)。
- 週末欄有課才顯示(週六要顯示)。
