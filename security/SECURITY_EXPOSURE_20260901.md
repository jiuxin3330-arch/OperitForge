...
進度:**C 做完了;A 已於 9/2 廢案,改行方案 B ——見 [`PLAN_B_PATH_TOKEN_20260902.md`](PLAN_B_PATH_TOKEN_20260902.md)。**

> 本檔記錄的是 9/1 當下的調查與 dash 處置。方案 A 的部分已成歷史,保留是為了留下「為什麼 A 不可行」的證據鏈。
